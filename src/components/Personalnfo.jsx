    ...
    <div id="personalInfo" className='about w-full bg-matBlack pb-16'>
        ...
        <div className='max-w-7xl mx-auto p-4 flex flex-col justify-center w-full h-full text-myColorDarker2'>
            <div className='flex flex-col md:flex-row justify-between items-center px-7'>
                ...
                <div className='mb-8 md:mb-0 md:text-start sm:text-center text-center py-2'>
                    <p className='md:text-4xl sm:text-3xl text-3xl border-b-4 border-myColorDarker2 inline md:ml-0 pb-1'>Additional Information</p>
                    <ul className='list-disc ml-7 mt-10 sm:text-start text-start'>
                ...
                <div className='md:mb-8 sm:mb-0 md:pr-5 sm:p-0'>
                    <p className='md:text-4xl sm:text-3xl text-3xl border-b-4 border-myColorDarker1 inline pb-1'>Additional links</p>
